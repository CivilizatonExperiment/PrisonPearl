...
public class PrisonPearlConfig {
    ...
    @CivConfig(name = "growthfactor", def = "1.0", type = CivConfigType.Double)
    public static double getGrowthFactor() {
        return PrisonPearlPlugin.getInstance().GetConfig().get("growthfactor").getDouble();
    }

    @CivConfig(name = "pearlingcost", def = "0", type = CivConfigType.Int)
    public static int getPearlingCost() {
        return PrisonPearlPlugin.getInstance().GetConfig().get("pearlingcost").getInt();
    }

    @CivConfig(name = "maxpearlspercontainer", def = "1", type = CivConfigType.Int)
    public static int getMaxPearlsPerContainer() {
        return PrisonPearlPlugin.getInstance().GetConfig().get("maxpearlspercontainer").getInt();
    }
}
